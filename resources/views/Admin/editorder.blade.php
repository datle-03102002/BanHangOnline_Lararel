        ...
        <div class="col-4">
            <div class="dathang-infor">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="hoten" name="hoten" value="{{$dh->hoten}}">
                </div>
                <div class="mb-3">
                    <label for="sdt" class="form-label">Số điện thoại</label>
                    <input type="text" class="form-control" id="sdt" required name="sdt" value="{{$dh->sodienthoai}}">
                </div>
                <div class="mb-4">
                    <label for="dc" class="form-label">Địa chỉ</label>
                    <input type="text" class="form-control" id="dc" required name="diachi" value="{{$dh->diachi}}">
                </div>
                <div class="mb-3">
                    <label for="ngaynhan" class="form-label">Ngày nhận</label>
                    <input type="date" class="form-control" id="ngaynhan" name="ngaynhan" value="{{$dh->ngaynhan}}">
                </div>
            </div>
        </div>
