                        ...
                        <div class="row cart-product-item mb-2 ms-1 me-1 item-{{ $key }}">
                            ...
                            <div class="col-2 d-flex align-items-center justify-content-center fw-semibold">
                                <div class="cart-product-quantity d-flex">
                                    ...
                                    <a href=""data-url="{{ route('updateCart', ['action' => 'giamsl', 'id' => $key]) }}"
                                        class="updateCart">
                                    ...
                                    <a href=""
                                        data-url="{{ route('updateCart', ['action' => 'tangsl', 'id' => $key]) }}"
                                        class="updateCart">
                                        <button type="button" class="btn btn-light btn-sm">
                            ...
                            <div class="col-1 d-flex align-items-center justify-content-center">
                                <div class="cart-product-action">
                                    <a href="" data-id="{{ $key }}"
                                        data-url="{{ route('deleteItem', ['id' => $key]) }}"
                                        data-name="{{ $item['ten'] }}"
                    ...
                    <div class="cart-product-foot rounded-3">
                        <div class="row h-100 justify-content-between">
                            ...
                            <div
                                ...
                                <button type="button" class="btn btn-primary"><a href="index.php?navigate=dathang"
